      ...
      >
                ...
                fields.map((field, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex flex-col gap-10 px-20 not-last:border-b not-last:border-b-gray-200 not-last:pb-20 last:pt-20"
                    >
                      <span>
                      ...
                      <div className="flex gap-20">
                        <button
                          ...
                          onClick={() => {
                            // FIXME: figure out why the checkbox is not being checked.
        ...
        <div>
          ...
          <p>
            ...
            <span id="form-required-input">verplicht veld</span> om in te
            vullen.
          </p>
        </div>
